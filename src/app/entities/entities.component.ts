...
export class EntitiesComponent implements OnInit {
  ...
  shouldBeHidden(e: Entity): boolean{
    ...
    else if (this.rdoActiveDormantAll == 'Active') inStatus = e.isActive;
    else if (this.rdoActiveDormantAll == 'Dormant') inStatus = !e.isActive;
    else if (this.rdoActiveDormantAll == 'Tasks') inStatus = e.tasksCount>0;
