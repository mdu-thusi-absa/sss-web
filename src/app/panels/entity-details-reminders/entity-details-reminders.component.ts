...
import { EntityNatural, AnyEntity, EntityFile, Entity } from 'src/app/data/data-entity-classes';
import { DataService } from 'src/app/data/data.service';

@Component({
  selector: 'app-entity-details-reminders',
  templateUrl: './entity-details-reminders.component.html',
  styleUrls: ['./entity-details-reminders.component.css']
})
export class EntityDetailsRemindersComponent implements OnInit {
